---
title: "Introducción al procesamiento de datos de la Encuesta Permanente de Hogares (EPH) - INDEC"
output: pdf_document
---
...
+ Clase 2 y 3: Procesamiento de datos con el paquete `Tidyverse` y `eph`:
...
+ Clase 4 y 5: Visualización de la información con `ggplot2`
...
+ Clase 6: Técnica de panel con la EPH
