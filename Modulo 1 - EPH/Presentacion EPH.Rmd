---
title: "LA EPH"
subtitle: "Presentación de la Encuesta Permanente de Hogares - INDEC"
...
knitr::include_graphics("img/ni_idea.gif")
```
...
knitr::include_graphics("img/Marco analitico_conceptual EPH.jpg")
```
...
- __Esquema operativo__: centralización normativa (equipo en la CABA) - descentralización ejecutiva (equipos provinciales).
...
knitr::include_graphics("img/poblacion_muestra.PNG")
```
...
--
      ...
      * El margen de error:
          ...
          - Coeficientes de variación de los estimadores (desvío estándar / media)
...
--
      ...
      * _Ocupado u ocupada_ (quienes se encuentran trabajando en la semana de referencia o no trabajando pero manteniendo un puesto de trabajo -suspensiones-)
  
--
  
      * _Desocupado o desocupada_ (quienes no tienen trabajo, están disponibles para trabajar y buscan trabajo activamente en algún momento de los últimos 30 días)
  
--
  
      * _Inactivo o inactiva_ (quienes no se encuentran trabajando ni buscaron activamente trabajo en el período de referencia -últimos 30 días-)
...
```{r echo=FALSE, out.width = '80%', fig.align = 'center'}
knitr::include_graphics("img/condicion_de_actividad_eph.png")
```
---
...
# Caracterízación de la pob. desocupada
...
```{r echo=FALSE, out.width = '80%', fig.align = 'center'}
knitr::include_graphics("img/Grafico_condicion_actividad_1t_2019.jpg")
```
